...
export const MODELS: ModelInfo[] = [
  ...
  { id: "claude-3-5-sonnet-latest", label: "Claude 3.5 Sonnet", provider: "anthropic", input: 3, output: 15, cache: 0.3 },
  { id: "claude-3-7-sonnet-latest", label: "Claude 3.7 Sonnet", provider: "anthropic", input: 3, output: 15, cache: 0.3 },
  { id: "claude-3-5-haiku-latest", label: "Claude 3.5 Haiku", provider: "anthropic", input: 0.8, output: 4, cache: 0.08 },
  { id: "claude-opus-4-20250514", label: "Claude Opus 4", provider: "anthropic", input: 15, output: 75, cache: 1.5 },
  // Kimi (Moonshot)
